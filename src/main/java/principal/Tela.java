...
public class Tela {
    ...
    public void telaInformacaoGrafoNaoOrientado() {
     ...
     public void telaInformacaoGrafoOrientado() {
        ...
        System.out.println("[r] ou [R]- Reduzir grafo por conexividade (cria um novo grafo reduzido)");
        System.out.println("0- Voltar");
        System.out.println("\n");
    }
    ...
    public void telaProblemas(){
        System.out.println("\n1- Caminho mínimo");
        System.out.println("2- Ordernar topologicamente");
        System.out.println("3- Encontrar vértice");
        System.out.println("0- Voltar");
    }
